...
column_to_be_centered = [[sg.T("")], [sg.Text("Enter URL of file to be downloaded"), sg.Input(key="sigmaR" ,change_submits=True)],
                            ...
                            [sg.Button("Submit")]]
        # [[sg.T("")], [sg.Text("Choose Number of Depth Propagations ")],
        ...
        #   [sg.T("")], [sg.Text("Choose Ground Truth Depth Image: "), sg.Input(), sg.FileBrowse(key="ground_truth")]]
...
window = sg.Window('Download Manager', layout, resizable=True,finalize=True)
